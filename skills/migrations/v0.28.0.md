...
1. **Schema verify** — schema migrations v34 (takes + synthesis_evidence)
   and v35 (access_tokens.permissions JSONB) ran; tables are present.
   (v31 was claimed by v0.25's eval_capture_tables and v32+v33 by v0.26's
   OAuth + admin dashboard before v0.28 landed.)
