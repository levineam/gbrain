/**
 * v0.20.0 migration orchestrator — Code Cathedral II.
 *
...
function phaseBBackfillPrompt(opts: OrchestratorOpts): OrchestratorPhaseResult {
  ...
  console.log('');
  console.log('=== v0.20.0 Cathedral II — code reindex options ===');
  console.log('');
...
async function orchestrator(opts: OrchestratorOpts): Promise<OrchestratorResult> {
  console.log('');
  console.log('=== v0.20.0 — Code Cathedral II ===');
...
export const v0_20_0: Migration = {
  version: '0.20.0',
  featurePitch: {
    headline: 'Code Cathedral II — chunk-grain FTS, qualified symbols, structural edges, 165-language lazy-load',
    description:
      'v0.20.0 ships the biggest code-search upgrade in gbrain history. Chunk-grain FTS ' +
